...
const TRANSLATIONS: Record<string, { ko: string; en: string }> = {
  ...
  'credit.pm.coinbase.sub': { ko: '크립토 지갑으로 결제', en: 'Pay with a crypto wallet' },
  'credit.pm.base.sub':    { ko: 'USDC 지갑으로 결제', en: 'Pay with a USDC wallet' },
  'credit.pm.bitpay.sub':  { ko: '코인 또는 스테이블코인', en: 'Coins or stablecoins' },
  'credit.pm.stripeGroup.sub': { ko: '카드 또는 스테이블코인', en: 'Card or stablecoin' },
  'credit.pm.stripeCard.title': { ko: '카드', en: 'Card' },
  'credit.pm.stripe.sub':  { ko: '카드 결제', en: 'Card payment' },
  'credit.pm.stripeCrypto.title': { ko: '스테이블코인', en: 'Stablecoin' },
  ...
  'credit.pm.binance.sub': { ko: 'Binance 지갑으로 결제', en: 'Pay with Binance Wallet' },
  ...
  'credit.err.cryptoSession': { ko: 'Stripe 스테이블코인 세션 생성 실패', en: 'Stripe stablecoin session could not be created' },
